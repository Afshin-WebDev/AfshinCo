...
const TopBanner = () => {
  const hiddenTheOffer = (e: MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    document.querySelector(".offer")?.classList.add("hidden");
  };

  return (
    <div className="offer bg-black text-white text-center py-2 px-2 sm:px-4 xl:px-0">
